const translation = {
  title: "Registros",
  description:
    "Los registros registran el estado de ejecución de la aplicación, incluyendo las entradas de usuario y las respuestas de la IA.",
  ...
  table: {
    ...
    empty: {
      ...
      element: {
        ...
        content:
          "Observa y anota las interacciones entre los usuarios finales y las aplicaciones de IA aquí para mejorar continuamente la precisión de la IA. Puedes probar <shareLink>compartiendo</shareLink> o <testLink>probando</testLink> la aplicación web tú mismo, y luego regresar a esta página.",
      },
    },
  },
  detail: {
    ...
    promptTemplateBeforeChat:
      "Plantilla de Indicación Antes de la Conversación · Como Mensaje del Sistema",
    ...
    operation: {
      ...
      annotationPlaceholder:
        "Ingresa la respuesta esperada que deseas que la IA responda, lo cual se puede utilizar para el ajuste del modelo y la mejora continua de la calidad de generación de texto en el futuro.",
    },
    variables: "Variables",
